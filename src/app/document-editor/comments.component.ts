...
export class CommentsComponent {
    ...
    public settings: DocumentEditorSettingsModel = { showRuler:true , commentSettings: { highlightCommentsByAuthor : true }, mentionSettings : { dataSource: this.mentionData, fields: { text: 'Name' }}  };
