...
export const pdfViewerAppRoutes: Object[] = [
    ...
    // tslint:disable-next-line:max-line-length
    { path: ':theme/pdfviewer/smartfill', component: SmartFillComponent, name: 'Smart Fill', order: '02', category: 'Smart AI Solutions', description: 'AI-assisted form filling in PDF Viewer.' },
    // tslint:disable-next-line:max-line-length
    { path: ':theme/pdfviewer/smartredact', component: SmartRedactComponent, name: 'Smart Redact', order: '02', category: 'Smart AI Solutions', description: 'AI-assisted redaction in PDF Viewer.' },
    // tslint:disable-next-line:max-line-length
    ...
    // tslint:disable-next-line:max-line-length
    { path: ':theme/pdfviewer/multi-format-viewer', component: MultiFormatViewerComponent , name: 'Multi-Format Viewer', order: '09', category: 'File Management', description: 'This sample demonstrates to loads various file types like PDFs, images, and Microsoft Office documents (Word, Excel, PowerPoint) into the PDF Viewer'}, 
    // tslint:disable-next-line:max-line-length
    { path: ':theme/pdfviewer/organize-pages', component: OrganizePagesComponent , name: 'Organize Pages', order: '10', category: 'Editor', description: 'This sample demonstrates the page organization features of the PDF Viewer component, allowing users to effortlessly insert, delete, rearrange, copy, undo, redo, and rotate pages.'},
    // tslint:disable-next-line:max-line-length
