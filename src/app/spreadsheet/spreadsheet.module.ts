...
import { CommentController } from './comment.component';
import { NotesController } from './notes.component';
import { PrintController } from './print.component';
import { SmartSpreadsheetComponent } from './ai-smart-spreadsheet.component';
...
export const spreadsheetAppRoutes: Object[] = [
    ...
    },
    {
        ...
        name: 'Cell Data Binding', category: 'Data Binding', order: '03',
    ...
    },
    {
        ...
        name: 'Remote Data Binding', category: 'Data Binding', order: '03',
    ...
    },
    {
        ...
        name: 'Number Formatting', category: 'Formatting', order: '04',
    ...
    },
    {
        ...
        name: 'Conditional Formatting', category: 'Formatting', order: '04',
    ...
    },
    {
        ...
        name: 'Sorting and Filtering', category: 'Data Analysis', order: '05',
    ...
    },
    {
        ...
        name: 'Chart', category: 'Data Visualization', order: '06',
    ...
    },
    {
        ...
        name: 'Image', category: 'Illustrations', order: '07',
    ...
    },
    {
        ...
        name: 'Cell Template', category: 'Templates', order: '08',
        description: 'This demo for Syncfusion<sup>®</sup> Angular Spreadsheet control shows cell template feature.'
    },
    {
        path: ':theme/spreadsheet/comment', component: CommentController,
        name: 'Comment', category: 'Review', order: '10',
        description: 'This demo for Syncfusion<sup>®</sup> Angular Spreadsheet control shows comment feature.'
    },
    {
        path: ':theme/spreadsheet/notes', component: NotesController,
        name: 'Notes', category: 'Review', order: '10',
    ...
    },
    {
        ...
        name: 'Print', category: 'Printing', order: '09',
